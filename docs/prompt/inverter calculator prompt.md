...
Display the wiring configuration, battery bank total Ah, raw/usable energy, full/actual load currents, estimated runtime, and recommended charge current range in a styled results card below the form.